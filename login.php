...
.btn{
    ...
    border-radius:12px; background:#ffeb71;
    color:black; font-weight:600;
    cursor:pointer; transition:0.3s;
}

.btn:hover{ transform:scale(1.06); box-shadow:0 0 15px #ffeb71; }

.social-box{ text-align:center; margin-top:20px; }
.social-box p{ margin-bottom:10px; }
...
.social-icons a:hover{
    transform:scale(1.15); background:#ffeb71; color:black;
}

.switch-link{ margin-top:18px; text-align:center; }
.switch-link a{ color:#8bd2ff; text-decoration:none; }
.switch-link a:hover{ text-shadow:0 0 8px #8bd2ff; }
